...
# #
img=ImageTk.PhotoImage(Image.open("22.webp"))

img2=ImageTk.PhotoImage(Image.open("l4.jpg"))

img3=ImageTk.PhotoImage(Image.open("l.webp"))
...
lbl = tk.Label(root, text="Liver Disease Detection System", font=('times', 35,' bold '), width=60,height=1,bg="#008080",fg="white")
lbl.place(x=0, y=0)




frame_alpr = tk.LabelFrame(root, text=" --Process-- ", width=220, height=450, bd=5, font=('times', 14, ' bold '),bg="skyblue")
...
def openimage():
    ...
    global fn
    fileName = askopenfilename(initialdir='D:/liver disease detection cnn/liver', title='Select image for Aanalysis ',
                               filetypes=[("all files", "*.*")])
    IMAGE_SIZE=200
    imgpath = fileName
    fn = fileName
...
button1 = tk.Button(frame_alpr, text=" Select_Image ", command=openimage,width=15, height=1, font=('times', 15, ' bold '),bg="pink",fg="black")
button1.place(x=10, y=50)

button2 = tk.Button(frame_alpr, text="Image_preprocess", command=convert_grey, width=15, height=1, font=('times', 15, ' bold '),bg="pink",fg="black")
button2.place(x=10, y=120)

# button3 = tk.Button(frame_alpr, text="Train Model", command=CL_SVM, width=12, height=1, font=('times', 15, ' bold '),bg="white",fg="black")
# button3.place(x=10, y=160)
#
button4 = tk.Button(frame_alpr, text="CNN_Prediction", command=test_model,width=15, height=1,bg="pink",fg="black", font=('times', 15, ' bold '))
...
button6 = tk.Button(frame_alpr, text=" Precautions ", command= process,width=15, height=1, font=('times', 15, ' bold '),bg="pink",fg="black")
button6.place(x=10, y=260)
