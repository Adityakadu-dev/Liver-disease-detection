...
image2 = Image.open('l2.webp')
image2 = image2.resize((1800,1200), Image.ANTIALIAS)
...
image2 = image2.resize((750,600), Image.ANTIALIAS)
...
btn = tk.Button(window, text="Create Account", bg="#008000",font=("",20),fg="white", width=15, height=0, command = insert)
